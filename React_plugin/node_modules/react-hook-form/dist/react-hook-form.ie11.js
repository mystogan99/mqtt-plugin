...
function useForm(_a) {
    ...
    var reset = function (values) {
        ...
        Object.values(resetFieldArrayFunctionRef.current).forEach(function (resetFieldArray) {
            return isFunction(resetFieldArray) &&
...
function useFieldArray(_a) {
    ...
    var _b = control || methods.control, resetFieldArrayFunctionRef = _b.resetFieldArrayFunctionRef, fieldArrayNamesRef = _b.fieldArrayNamesRef, globalFields = _b.fields, defaultValues = _b.defaultValues, unregister = _b.unregister;
    var _c = __read(React.useState(mapIds(get(defaultValues, name))), 2), fields = _c[0], setField = _c[1];
    var resetFields = function () {
        for (var key in globalFields) {
    ...
    var append = function (value) {
        return setField(__spread(fields, [appendId(value)]));
    };
