...
function useFieldArray({ control, name }) {
    ...
    const [fields, setField] = React.useState(mapIds(get(defaultValues, name)));
    const resetFields = () => {
...
const Controller = (_a) => {
    ...
    const methods = useFormContext();
    const { defaultValues, setValue, register, unregister, errors, mode: { isOnSubmit, isOnBlur }, reValidateMode: { isReValidateOnBlur, isReValidateOnSubmit }, formState: { isSubmitted }, fields, fieldArrayNamesRef, } = control || methods.control;
