...
var TestPage = /** @class */ (function () {
    function TestPage(config) {
        ...
        this.pageObjects = {};
        Object.keys(config.pageObjects).map(function (key) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var selector;
            return tslib_1.__generator(this, function (_a) {
                selector = config.pageObjects[key];
                if (typeof selector === 'function') {
                    this.pageObjects[key] = new pageObjects_1.PageObject(selector());
                }
                if (typeof selector === 'string') {
                    this.pageObjects[key] = new pageObjects_1.PageObject(pageObjects_1.Selector.fromAriaLabel(selector));
                }
                return [2 /*return*/];
            });
        }); });
