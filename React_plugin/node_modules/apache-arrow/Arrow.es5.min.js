...
function jf(a){this.children=this.children=a}k.b(jf,M);jf.prototype.toString=function(){return"Struct<{"+this.children.map(function(a){return a.name+":"+a.type}).join(", ")+"}>"};k.global.Object.defineProperties(jf.prototype,{typeId:{configurable:!0,enumerable:!0,get:function(){return I.Struct}}});k.l();var kf=Symbol.toStringTag,lf,mf=jf.prototype;mf.children=null;k.l();lf=mf[Symbol.toStringTag]="Struct";jf[kf]=lf;
...
function Un(a,b){var c=new Q([new P("values",a.type),new P("counts",b.type)]);S.call(this,new Jk(c,b.length,[a,b]))}k.b(Un,S);Un.prototype.toJSON=function(){for(var a=this.getColumnAt(0),b=this.getColumnAt(1),c={},f=-1;++f<this.length;)c[a.get(f)]=b.get(f);return c};k.l();k.D();function Tn(a,b){Sn.call(this,a);this.Ea=b}k.b(Tn,Sn);Tn.prototype.scan=function(a,b){for(var c=this.I,f=c.length,d=-1;++d<f;){var e=c[d];b&&b(e);for(var h=this.Ea.bind(e),l=-1,m=e.length;++l<m;)h(l,e)&&a(l,e)}};
Tn.prototype.scanReverse=function(a,b){for(var c=this.I,f=c.length;0<=--f;){var d=c[f];b&&b(d);for(var e=this.Ea.bind(d),h=d.length;0<=--h;)e(h,d)&&a(h,d)}};Tn.prototype.count=function(){for(var a=0,b=this.I,c=b.length,f=-1;++f<c;)for(var d=b[f],e=this.Ea.bind(d),h=-1,l=d.length;++h<l;)e(h,d)&&++a;return a};
